...
- deeper charcoal workshop base palette shared by existing surfaces;
...
An experimental shared `SteamUi.kt` layout/drawing material pass was tested during development but caused Activity recreation instability in emulator CI. That implementation change was removed from this PR; the proven master `SteamUi` implementation remains in place and only inherits the updated shared palette.
...
- no shared app-shell layout/drawing redesign in this pass.
