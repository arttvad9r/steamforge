 ...
 *
 * The fixture creates the densest legal merge burst for a 4x4 board: every row contains
 * two mergeable pairs, so one horizontal swipe produces eight merge events plus a spawn.
 */
