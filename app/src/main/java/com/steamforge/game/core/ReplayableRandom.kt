...
/**
 * Stable SplitMix64-style stream with a serializable draw position.
 *
 * This algorithm is part of deterministic save/replay semantics. Do not replace it with
 * `Random(seed)` or change its constants/output without an explicit protocol/save migration.
 */
